 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Qp;function y_(){if(Qp)return Xo;Qp=1;var r=cf(),e=Symbol.for("react.element"),n=Symbol.for("react.fragment"),s=Object.prototype.hasOwnProperty,a=r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,l={key:!0,ref:!0,__self:!0,__source:!0};function u(f,p,m){var x,S={},g=null,y=null;m!==void 0&&(g=""+m),p.key!==void 0&&(g=""+p.key),p.ref!==void 0&&(y=p.ref);for(x in p)s.call(p,x)&&!l.hasOwnProperty(x)&&(S[x]=p[x]);if(f&&f.defaultProps)for(x in p=f.defaultProps,p)S[x]===void 0&&(S[x]=p[x]);return{$$typeof:e,type:f,key:g,ref:y,props:S,_owner:a.current}}return Xo.Fragment=n,Xo.jsx=u,Xo.jsxs=u,Xo}var em;function M_(){return em||(em=1,Ru.exports=y_()),Ru.exports}var G=M_(),dl={},Lu={exports:{}},ni={},Du={exports:{}},Iu={};/**
 * @license React
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
      ...
      `}),G.jsx("div",{ref:r,style:{width:"100%",height:"100%",touchAction:"none"}}),G.jsx(tE,{isMobile:_,loaded:u,loadingProgress:T,activeZone:n,hovered:p,showHint:a,splitScreen:Y,guidedTour:w,tourZoneIndex:j,setGuidedTour:I,comparisonMode:b,idlePrompt:tt,showWelcome:ke,showHelp:x,tutorialStep:Se,inspectorMode:ge,patientSimActive:Z,occupancy:ie,tourRef:e.current.tour}),G.jsx(nE,{isMobile:_,comparisonMode:b,setComparisonMode:L,showHelp:x,setShowHelp:S,onTutorialAction:ht,tutorialHighlight:V}),u&&!ke&&G.jsx($M,{activeZone:n,isMobile:_,handleZoom:se=>{ht("click_zone"),gt.current(se)},handleReset:kt.current,tutorialHighlight:V}),u&&!ke&&Se<0&&(en||p)&&!_&&G.jsx(KM,{displayZone:en||p,activeZone:n,isMobile:_,goToAdjacentZone:Gt}),G.jsx(ZM,{loaded:u,welcomePhase:ue,setWelcomePhase:Te,setShowWelcome:je,setTutorialStep:Ge,isMobile:_}),G.jsx(JM,{tutorialStep:Se,setTutorialStep:Ge,handleReset:kt.current,isMobile:_}),G.jsx(iE,{showHelp:x,setShowHelp:S,isMobile:_,setTutorialStep:Ge,setWelcomePhase:Te}),G.jsx(QM,{isMobile:_,showTools:pe,setShowTools:U,heatmapMode:P,setHeatmapMode:z,patientSimActive:Z,setPatientSimActive:he,guidedTour:w,setGuidedTour:I,splitScreen:Y,setSplitScreen:ce,inspectorMode:ge,setInspectorMode:W,setInspectedItem:$,circadianTime:D,setCircadianTime:k,comparisonMode:b,onTutorialAction:ht,tutorialHighlight:V}),G.jsx(eE,{inspectedItem:ne,setInspectedItem:$,isMobile:_})]})}C_.createRoot(document.getElementById("root")).render(G.jsx(rE,{}));
